...
export function Hero({
    ...
    return (
        ...
        >
            ...
            {/* ── Content ── */}
            <div className="relative z-10 mx-auto flex w-full max-w-5xl flex-col items-center px-5 py-28 text-center sm:px-8 md:py-36 lg:py-44">
                {/* ── Urgency badge ── */}
                {isEarlyBird && (
                    <motion.div {...fadeUp(0)}>
                ...
                <motion.p
                    ...
                    className="mt-3 text-2xl font-bold tracking-tight text-transparent bg-clip-text bg-gradient-to-r from-accent via-primary to-[#c084fc] sm:text-3xl md:text-4xl lg:text-5xl md:mt-4"
                >
                    {tagline}
                </motion.p>
                ...
                <motion.p
                    ...
                    className="mx-auto mt-5 max-w-xl text-base font-medium text-foreground/70 sm:text-lg md:mt-6 md:text-xl"
                >
                    {description}
                </motion.p>
                ...
                >
                    <Link
                        ...
                        className="btn-glow group relative inline-flex h-14 items-center justify-center gap-2 rounded-full bg-primary px-10 text-lg font-bold text-primary-foreground shadow-xl shadow-primary/25 transition-all duration-300 hover:scale-105 hover:shadow-primary/40 sm:h-16 sm:px-12 sm:text-xl"
                    >
                        Register Now
                ...
                <motion.div
                    ...
                    className="mt-12 flex items-center gap-2 sm:gap-3 md:mt-16"
                >
                    {[
                        ...
                        <React.Fragment key={unit.label}>
                            {i > 0 && (
                                <span className="text-xl font-bold text-primary/50 select-none sm:text-2xl">
                                    :
                                </span>
                            )}
                            <div className="glass flex flex-col items-center rounded-xl px-3.5 py-2.5 min-w-[56px] sm:min-w-[68px] sm:rounded-2xl sm:px-5 sm:py-3">
                                <span className="text-2xl font-black tabular-nums text-foreground sm:text-3xl md:text-4xl">
                                    {mounted ? pad(unit.value) : '--'}
                                </span>
                                <span className="mt-0.5 text-[10px] font-semibold uppercase tracking-widest text-foreground/50 sm:text-xs">
                                    {unit.label}
                                </span>
                            </div>
                        </React.Fragment>
                ...
                <motion.div
                    ...
                    className="mt-10 flex flex-col items-center gap-4 text-foreground/60 sm:flex-row sm:gap-6 md:mt-14"
                >
